import { handleSpacecatProxyRequest } from '../server/spacecat-proxy.js';
import {
...
const proxyEnv = {
  ...
  SPACECAT_SESSION_TOKEN: runtimeEnv.SPACECAT_SESSION_TOKEN,
  ...
  SPACECAT_IMS_ACCESS_TOKEN: runtimeEnv.SPACECAT_IMS_ACCESS_TOKEN,
...
export default {
  async fetch(request: Request) {
    ...
    return withCors(
      request,
      await handleSpacecatProxyRequest(request, proxyEnv),
      proxyEnv,
    );
  },
};
